...
aptest.commands = bash $$PWD/PockIt/tests/autopilot/run
aptest.depends  = sub-PockIt

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/PockIt/tests/unit
unittest.depends  = sub-PockIt
